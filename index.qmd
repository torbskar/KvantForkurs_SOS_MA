...
En av de store forskjellene fra SPSS og Stata er at R **ikke** er menybasert. Du kan altså ikke gjøre analyser med "pek-og-klikk"! Det bør du jo egentlig uansett ikke gjøre i andre software heller - så forhåpenligvis har du lært å skrive kode fra før. R er altså et programmeringsspråk, og det er viktig å lære å skrive kode. I tillegg til programmeringsspråket skal du lære å lage en hensiktsmessig mappestruktur og lese inn datasett i R. 
